...
char* ignore_first_apostrophe(char* expression, bool is_E_flag);
    ...
    bool is_E_flag)
{
    ...
    regex_array = (Regex_Block*)malloc(sizeof(Regex_Block) * (regex_array_len));
    ...
    char* rest_of_expression = ignore_first_apostrophe(expression, is_E_flag);
